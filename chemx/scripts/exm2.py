...
=== EXCERPTS ===
{md}"""
PAPERS=['antibiotics10081002','acsomega.2c06142','s41598-022-21435-6','s13065-018-0479-1','d2ra06667j','intechopen.108949']
DIR='/tmp/ChemX/LLM/data/pdfs/pdf_benzimidazole'
for name in PAPERS:
    t0=time.time()
    try:
        md=focus(extract_pdf_mistral(DIR+'/'+name+'.pdf', timeout=280)['text'])
